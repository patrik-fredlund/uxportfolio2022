    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          read the companies documentation in order to learn more about thier
          brand, marketing plan, USP and what they wanted to say. With my new
          knowledge and insights I started to create a user test for the
          website.
        </p>
