      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            with my recomendations and I started to impliment them to thw
            website. The exixiting site was built in Squerespace so I redesigned
            it and applied the changes according to my solutions. This is still
            an ongoing process but during my time I'we got the chance I focused
            on the proirotized issues, such as navigation, first impression and
            delivery of the message, to make the website more product-centric.
          </p>
        </div>
        {/*  <h1>Recomended solutions </h1>
        <p className='MiddleIngressParagraph'>
