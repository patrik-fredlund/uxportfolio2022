        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              ...
              <li>
                {' '}
                <span className='bold'>Add navigation menu</span> to the top.{' '}
              </li>
              <li>
                All features should be{' '}
                <span className='bold'>accessible from the landing-page.</span>
              </li>
              <li>
                <span className='bold'>Add call to action</span> to the top and
                always keep it visible. Download-Link of the app.
              </li>
            </div>
            <div className='card'>
              <h2>2. Content </h2>
