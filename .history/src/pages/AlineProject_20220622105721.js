        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              ...
              <h4>Solution with User pains with the structure:</h4>
            ...
            <div className='card'>
              <h2>2. Content </h2>
              <h3>Features.</h3>
              <h4>Solution with User pains with the Content:</h4>
              Prioritize the features in order of importance. Only use content
              that’s necessary. Remove the rest. No repetitive features or text
              Iconography needs to be consistent Obvious Image Bank pictures.
              Feels cheap.
