    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          plan, usp and what they wanted to say. <br /> I also reserached the
          exixiting website before I did the test so I could get a sence of the
          whole. <br /> With my new knowledge and insights I started to create a
          user test for the website.
        </p>
