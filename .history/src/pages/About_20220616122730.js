    ...
    <Wrapper>
      ...
      <AboutContainer>
        <p className='aboutIngress'>
          ...
          with exciting projects from scratch. <br />{' '}
          <b className='bolder'>
            I just graduatedfrom KYH where I studied Frontend Development,
          </b>{' '}
          to learn to design on the web. <br /> Since erlier I have a{' '}
          < className='bolder'>BA(hons) in graphic design with a focus on{' '}
         typography,</b> from University College for the
          Creative Arts at Farnham, England. <br /> My strengths are{' '}
          <b className='bolder'>
            {' '}
            my drive and commitmnet, problem solving and graphic design,
          </b>{' '}
          and{' '}
          <b className='bolder'>
          ...
          <b className='bolder'>drive and energy</b> I looking forward to work
          in a creative environment with an inspiring team. <br /> I’m also{' '}
