      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainerMethods'>
            ...
            <p>
              For the UX analysis I will use the double Dimond method, to
            ...
            <p>
              <h3>target group analysis</h3>I will do a{' '}
              <span className='bold'> target group analysis</span> in the form
              of interviews and an survey. I will present this is a value
              propostition canvas.
            </p>
            <p>
              <h3>competitor analysis</h3>I will do a{' '}
              <span className='bold'>competitor analysis</span> in the form of
              interviews and an survey in order to get feedback from the users.
              I will present this is a value propostition canvas.
            </p>
            <h3>Ideation</h3>
            <p>
