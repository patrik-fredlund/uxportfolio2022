      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            process, but when I was stil an intern there I focused on the
            prioritized issues, such as better navigation, more direct delivery
            of the concept and a more on point first impression, To make the
            website more product-centric. The original site was built in
            Squarespace and the changes is a redsign of that site.
          </p>
        </div>
