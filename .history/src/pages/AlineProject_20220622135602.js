      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            that with focus on the prioritized issues, such as navigation, first
            impression and delivery of the message, to make the website more
            product-centric. This is still an ongoing process but during my time
            I'we got the chance I focused on the proirotized issues,
          </p>
        </div>
        {/*  <h1>Recomended solutions </h1>
        <p className='MiddleIngressParagraph'>
