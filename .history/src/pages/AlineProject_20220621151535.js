    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperInter'>
          <div className='uxProjectContainer'>
            ...
            <li>
              ...
              professional opinion and in-depth feedback:
              <ul>
                {' '}
                <li>Up to date knowledge on today’s trends</li>
                <li>Design rules and recommendations</li>
        ...
        <p className='ingressParagraph'>
          ...
          of what they needed to communicate and to who. I talked to the
          stakeholder and read all thier content in order to learn more about
          thier brand, marketing and what they wanted to say. With my new
          knowledge and insights I started to create a user test for the
          website. I also reserached the exixiting website before I did the test
          so I could get a sence of the whole.
        </p>
