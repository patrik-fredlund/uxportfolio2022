        ...
        <div className='headerWrapper'>
          <div className='headerProjectContainer'>
            ...
            <p className='explainerText'>
              ...
              UX-designer, as part of the 2 year frontend development education
              at KYH in Stockholm. We did UX-design courses in the frontend
              education and I really got hooked, and quikly knew that I wanted
              to proceed a career within UX. My main task at Aline was to do a
              UX analysis of thier exisitng website.
      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            built in Squearespace I redesigned that.
          </p>
        </div>
        {/*  <h1>Recomended solutions </h1>
        <p className='MiddleIngressParagraph'>
