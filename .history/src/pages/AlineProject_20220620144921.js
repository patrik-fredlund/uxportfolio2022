      ...
      <UxProject>
        ...
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            ...
            <p>
              For curious current and future professionals, who are dissatisfied
              with the lack of proof for their learning efforts, our product is
              a learning platform and knowledge network, that provides a
              commonplace for career and personal development, unlike static and
              isolated online course suppliers, we can provide a personalized
              learning experience that validates skills and competencies.{' '}
            </p>
