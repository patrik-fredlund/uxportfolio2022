    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              <br />
              In this analysis I will focus mainly on the discover, define and
              recomendations phase, since the design phase is still an ongoing
              process.
            </p>
        ...
        <div className='competitorsContainer'>
          ...
          <video className='alinePres' width='300' height='auto' controls>
            <source
        ...
        <p className='MiddleIngressParagraph'>
          ...
          slogan, all in purpose to make the website more product centric,
