  ...
  return (
    <Wrapper>
      <UxProject>
        ...
        <div className='wrapPack'>
          <div className='screeenShotsWrapperStart'>
            <img
              className='iphoneStart'
      ...
      <UxProject>
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              mobile phones.{' '}
              <span className='bold'>
                The prototype should cover the main flow from start to finish.
              </span>
            </p>
          </div>
        </div>
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              discover, define, develop and deploy the app in a strucured and
              effective way, to reach the best possible end-product.
            </p>
            <h1>Tools</h1>

            <p>
              <h3>Target group analysis</h3>I have done a target group analysis
              in the form of interviews and a survey. I will present this in a{' '}
            ...
            <h3>Ideation</h3>
            <p>
              I've had workshops where I ideate the ideas of the app such as
            ...
            <p>
              ...
              whole design, then iterated and created a working prototype of the
              main user flow.
            </p>
          </div>
        </div>
        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            ...
            <div className='card'>
              ...
              <li>Competitors </li>
              <li>Features </li>
              <li>Prioritize the features for a MVP prototype </li>
            </div>
            <div className='card'>
        ...
        <div className='uxProjectWrapperBlue'>
          <div className='uxProjectContainer'>
            <p className='posItText'>
              I want to make it easier for the user to eat their purchased food
        ...
        <p className='MiddleIngressParagraph'>
          That's the basic idea of the app and the two main features which will
          bring <span className='bold'>value to the user.</span> With that in
          mind the next step of the discovery was to do a competitor analysis.
        </p>
        <hr></hr>
        ...
        <p className='ingressParagraph'>
          {/*        <h1>Conclution of the competitor analysis</h1> */}
      ...
      <UxProject>
        <h1 className='projectTitle'>Define the user</h1>
        <hr />
        ...
        <p className='ingressParagraph'>
          ...
          this app as it is your{' '}
          <span className='bold'>storage and shoppinglist.</span> So either you
          have the food item at home, or you get a reminder to add it to your
          shopping list.
        </p>
        ...
        <p className='ingressParagraph'>
          ...
          Here's the final result of the main user flow:
        </p>
        ...
        <hr />
        <p className='subHeader'>
          Thank you for taking your time to see my work. Please feel free to get
