      ...
      <UxProject>
        <div className='headerWrapper'>
          <div className='headerProjectContainer'>
            ...
            <p>
              Aline is a startup within edtech, ie Educational Technology. Their
              service is an App that is a platform for more effective learning.
              There is currently a beta version, so all the features are not
              ready yet, but the plan is for the app to be launched this spring.
