      ...
      <UxProject>
        ...
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            <h1 className='altTitle'>Project brief</h1>
            <p>
              ...
              <br />
              <span className='bold'>
                In this presentation I will focus mainly on the discover, define
                and recomendations phase, since the design phase is still an
                ongoing process.
              </span>
            </p>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              tests, in order to make the website more user friendly. In this
              analysis I will focus mainly on the discover, define and
              recomendations phase, since the change of the UI on the website is
              still an ongoing process. But some design will be presented at the
        ...
        <div className='competitorsContainer'>
          ...
          <h1 className='demoTitle'>Demo of the presentation </h1>

          <video className='alinePres' controls>
            <source
              src={require('../Images/Aline_pres.mp4')}
              type='video/mp4'
            />
        ...
        <h1 className='altTitle'>Define the insights </h1>
        <p className='MiddleIngressParagraph'>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            the Website. This is still an ongoing process, but during my time
            I've I Focused on the prioritized issues, such as better navigation,
            more Direct delivery of the concept and a more on point first
            impression, To make the website more product-centric. Since the
            original site was built in Squarespace we decided I would redsign
            that interface.
          </p>
        </div>
        ...
        <p className='MiddleIngressParagraph'>
          ...
          Main menu. The website is still in the process of implementing all cha
        </p>
