    ...
    <Wrapper>
        ...
        <div className='headerWrapper'>
          <div className='headerProjectContainer'>
            ...
            <p className='explainerText'>
              ...
              wanted to proceed a career within UX. My first task at Aline was
              to do a UX analysis of thier exisitng website.
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          needed to communicate and to whom. <br /> I talked to the stakeholder,
        ...
        <div className='uxProjectWrapperYellow'>
          <div className='uxProjectContainer'>
            <p className='posItText'>
              ...
              approach. Afer testing the website myself I agreed with the
              Stakeholder. I felt a user test would be an effective way to get
              valuble insight from the target group.
            </p>
          </div>
        </div>
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            Aline. I made it into a story mode to make it more engaging and fun.
          </p>
        </div>
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            effective to find better solutions.
          </p>
        </div>
        <h1>Define the insights </h1>
        <p className='MiddleIngressParagraph'>
          I divided the feedback into 4 main categories where the users find
          their pain points:
        </p>
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            ...
            <div className='card'>
              ...
              <p>
                ...
                short. What is it (really)? Why should you use it? How does it
                work?
              </p>
            </div>
          </div>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            After collecting and analysing all the data from the interviews I
            organized it into areas of friction to get a better understanding of
            the issues. Then I had a ideation workshop to generate solution
            ideas for each area.
          </p>
        </div>
        <h1>Recomended solutions </h1>
        <p className='MiddleIngressParagraph'>
          Below I collected my recomendations within the 4 categories.
        </p>
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              ...
              <h4>Solutions with User pains with the structure:</h4>
            ...
            <div className='card'>
              <h2>2. Content </h2>
              <h3>Features.</h3>
              <h4>Solutions with User pains with the Content:</h4>
            ...
            <div className='card'>
              <h2>3. Descriptions </h2>
              <h3>Explanations and Language.</h3>
              <h4>Solutions with User pains with the descriptions:</h4>
            ...
            <div className='card'>
              <h2>4. Message </h2>
              <h3>Delivery of the concept.</h3>
              <h4>Solutions with User pains with the message:</h4>
              <h3>The Message</h3>
              <p>
              ...
              <p>
                ...
                easy to understand. Deliver the whole picture.
              </p>
            </div>
          </div>
        </div>
