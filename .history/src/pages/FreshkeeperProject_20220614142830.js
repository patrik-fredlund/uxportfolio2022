      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainerMethods'>
            ...
            <h3>Wireframing</h3>
            <p>
              I will create wireframe and user flow of the app and the user
              journey.
            </p>
            ...
            <p>
              {' '}
              In Figma I will first create a lo-fi prototype to get a sence of
              the whole, then iterate and create a working prototype of the main
              user flow.
            </p>
          </div>
        </div>
