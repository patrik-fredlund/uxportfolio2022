        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              ...
              <p>User pains with the structure:</p>
            ...
            <div className='card'>
              <h2>2. Content </h2>
              <h3>Features.</h3>
              <p>User pains with the Content:</p>
            ...
            <div className='card'>
              ...
              <p>User pains with the descriptions:</p>
              <h3>The language.</h3>
              <p>
                Too much academic lingo, slogans and fancy words. Hard to
                understand if you’re not and expert on the subject.
              </p>
            </div>
            <div className='card'>
              <h2>4. Message </h2>
