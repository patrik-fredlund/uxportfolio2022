    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <h2 className='projectTitle'>Solution</h2>
          <p className='MiddleIngressParagraph'>
            After the presentation the stakeholder and team agreed with my
            recomendations and I started to impliment them to thw website. The
            exixiting site was built in Squerespace so I redesigned it and
            applied the changes according to my solutions. This is still an
            ongoing process but during my time I'we got the chance I focused on
            the proirotized issues, such as navigation, first impression and
