    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='MiddleIngressParagraph'>
          ...
          user-friendly and straight to the point. Right now the call to action
          to download the App is on hold becouse of maintaince of the App.
          Before that their was a download lin in the menu
        </p>
        <img
          className='alineNew'
