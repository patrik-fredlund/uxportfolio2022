      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='insightsContainer'>
            ...
            <p>
              automatic Scanning a food item, like scanning a qr-code don't work
              well, according to the competitor analysis, so it's better to
              manually register items, but how? This is the most important
              feature of the app so it needs to be easy and quick to do.
            </p>
          </div>
          <div className='insightsContainer'>
