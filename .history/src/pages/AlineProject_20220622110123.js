        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            ...
            <div className='card'>
              ...
              <h4>The Message.</h4>
              <p>The product has got great potential, but it will fall short if the delivery is not on point.</p>
<h4>Example</h4>
<p>Spotify don’t talk about what music can do for you, they say: Here you can listen to music.
Straight to the point, simple and easy to understand. Deliver the whole picture.
</p>
