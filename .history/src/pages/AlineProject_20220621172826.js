      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            ...
            <div className='card'>
              ...
              <h2>Define Insights</h2>
              <h3>research the feedback</h3>
              <li>Analyse what they mean</li>
              <li>Define the insights</li>
              <li>Write recomendations</li>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            Because of the allready exixting website I decided to use the lab
            usability testing method and do a live user test and interview the
            user when he/she interacted with the site to learn from thier
            experience.
          </p>
        </div>
        <div className='competitorsContainer'>
