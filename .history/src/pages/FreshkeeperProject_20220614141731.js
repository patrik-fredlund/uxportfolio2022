      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainerMethods'>
            ...
            <h3>UX tools</h3>
            <p>
              I will do a target group analysis in the form of interviews and an
              survey. I will present this is a value propostition canvas.
            </p>
            <p>
              I will do a competitor analysis in the form of interviews and an
              survey in order to get feedback from the users. I will present
              this is a value propostition canvas.
            </p>
            <h3>interviews</h3>
            <h3>Survey</h3>
            <h3>Survey</h3>
