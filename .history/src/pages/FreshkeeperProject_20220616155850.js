    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          meant it was time to create the UI. For me it's very rewarding to
          build the final prototype, and since the groundwork been done the
          guidelines been set in the UX research. First step was to create the
          design elements and decide fonts and colors, according to the insights
