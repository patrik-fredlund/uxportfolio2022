    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainerMethods'>
            <h1>Tools and methods</h1>
            <h3>For this task I will use the following methods</h3>
            <h3>Scrum</h3>
            <p>
              I will use the scrum method for the work process and work in
              sprints. I will create a backlog and divide it up in a scrum board
              in trello, in order to keep the project organized and structured
              in the best way possible.
            </p>
            <h3>Double Dimond Method</h3>
            <p>
              I will use the double Dimond method for the UX analysis, to
              discover, define, develop and deploy the app in an strucured and
              effective way, to reach the best possible endproduct.
            </p>
            <h3>UX tools</h3>
            <p>
              I will do a <span className='bold'> target group analysis</span>{' '}
              in the form of interviews and an survey. I will present this is a
              value propostition canvas.
            </p>
            <p>
              I will do a <span className='bold'>competitor analysis</span> in
              the form of interviews and an survey in order to get feedback from
              the users. I will present this is a value propostition canvas.
            </p>
            <h3>Ideation</h3>
            <p>
              I will have workshops where I ideate the ideas of the app such as
              possible features, name and concepts.
            </p>
            <h3>Wireframing</h3>I will create wireframe and user flow of the app
            and the user journey.
            <h3>Prototyping</h3>
            In Figma I will first create a lo-fi prototype to get a sence of the
            whole, then iterate and create a working prototype of the main user
            flow.
          </div>
        </div>
