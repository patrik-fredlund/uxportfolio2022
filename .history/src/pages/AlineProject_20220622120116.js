    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          The first part of the research was for me to{' '}
          <span className='bold'>
            learn more about Aline, their concept and vision, to get a better
            understanding of what they needed to communicate and to whom.{' '}
          </span>{' '}
          <br /> I talked to the stakeholder, marketing strategist and employees
          and read the companies documentation in order to learn more about
          thier brand, marketing plan, USP and what they wanted to say. With my
          new knowledge and insights I started to create a user test for the
          website.
        </p>
