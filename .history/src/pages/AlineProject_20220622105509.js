        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              <h2>1. Structure</h2>
              <h3>Page layout and parts.</h3>
              Add navigation menu to the top. All features should be accessible
              from the landing-page. Add call to action to the top and always
              keep it visible. Download-Link of the app
              <h4>Solution with User pains with the structure:</h4>
              <li>Add navigation menu to the top. </li>
              <li>ll features should be accessible from the landing-page.</li>
              <li>
