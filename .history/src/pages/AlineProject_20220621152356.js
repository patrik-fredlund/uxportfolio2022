    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          stakeholder, marketing strategist and employees and read all thier
          content in order to learn more about thier brand, marketing plan and
          what they wanted to say. <br /> I also reserached the exixiting
          website before I did the test so I could get a sence of the whole.{' '}
          <br /> With my new knowledge and insights I started to create a user
