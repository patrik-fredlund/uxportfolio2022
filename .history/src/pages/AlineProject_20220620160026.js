      ...
      <UxProject>
        ...
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            ...
            <li>
              Thru out the user test I let the test user give me feedback <br />{' '}
              of what they felt and thought, and asked them why, in order to get
              more deeper understanding of thier experinece.
            </li>
