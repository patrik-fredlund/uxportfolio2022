      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            more on point first impression, To make the website more
            product-centric. The original site was built in Squarespace and the
            changes is a redsign of that site.
          </p>
        </div>
