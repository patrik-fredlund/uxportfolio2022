  ...
  return (
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              <span className='bold'>competitor analysis</span> and it will be
              presented in a pains and gains for the users
            </p>
            <h3>Ideation</h3>
            <p>
        ...
        <p className='MiddleIngressParagraphProblem'>
          With that in mind I had ideation and came up with the following
          problemstatement:
        </p>
