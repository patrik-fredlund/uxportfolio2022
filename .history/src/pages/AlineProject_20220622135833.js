    ...
    <Wrapper>
        ...
        <div className='headerWrapper'>
          <div className='headerProjectContainer'>
            ...
            <p className='explainerText'>
              ...
              education at KYH in Stockholm. We did UX-design courses in the
              frontend education and I really got hooked, and quikly knew that I
              wanted to proceed a career within UX. My main task at Aline was to
              do a UX analysis of thier exisitng website.
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperMethods'>
          <div className='uxProjectContainer'>
            ...
            <p>
              ...
              their pains and gains when interacting with the website.
            </p>
          </div>
        </div>
        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
              ...
              <li>Interview mareketing strategist and Employees</li>
        ...
        <p className='ingressParagraph'>
          ...
          their concept and vision, to{' '}
          <span className='bold'>
            get a better understanding of what they needed to communicate and to
            whom.{' '}
          </span>{' '}
          I talked to the stakeholder, marketing strategist and employees and
          read the companies documentation in order to{' '}
          <span className='bold'>
        ...
        <div className='uxProjectWrapperYellow'>
          <div className='uxProjectContainer'>
            <p className='posItText'>
              ...
              <span className='bold'>
                {' '}
                the website needed a clearer message and to be more simple in
                its approach.
              </span>{' '}
              Afer testing the website myself I agreed with the Stakeholder. I
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            see presentation of the user test which I presented for the team at
            Aline. I made it into a <span className='bold'>story mode </span> to
        ...
        <p className='MiddleIngressParagraph'>
          ...
          <span className='bold'> 4 main categories</span> where the users find
          their pain points:
        </p>
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            ...
            <div className='card'>
              ...
              <p>
                Just like the descriptions, the delivery of the concept falls
        ...
        <p className='MiddleIngressParagraph'>
          I sorted my recomendations within the 4 categories.
        </p>
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <div className='card'>
            ...
            <div className='card'>
              ...
              <h3>The Message</h3>
              <p>
                The product has got great potential, but it will fall short if
                the delivery is not on point.
              </p>
              <h3>Example</h3>
              <p>
        ...
        <div className='competitorsContainer'>
          <p className='subHeader'>Part 4 - Design</p>
          <h2 className='projectTitle'>Implimnet the changes</h2>
          <p className='MiddleIngressParagraph'>
            After the presentation the stakeholder and rest of the team agreed
            with my recomendations and I started to impliment them to the
            website. This is still an ongoing process but during my time I'we
            got the chance I focused on the proirotized issues,, such as
            navigation, first impression and delivery of the message, to make
            the website more product-centric. Since the orignal site was built
            in Squearespace I redesigned that.
          </p>
        </div>
        {/*  <h1>Recomended solutions </h1>
        <p className='MiddleIngressParagraph'>
