    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='MiddleIngressParagraph'>
          ...
          maintaince of the App. Before that their was a download link in the
          main menu. So the website is still in the process of implimenting my
          recomendations.
        </p>
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'></div>
          <p></p>
        </div>
