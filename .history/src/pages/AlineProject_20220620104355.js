    ...
    <Wrapper>
      <UxProject>
        <div className='headerWrapper'>
          <div className='headerProjectContainer'>
            ...
            <p className='explainerText'>
              ...
              an App that is a platform for more effective learning.
            </p>
          </div>
        </div>
        <img
        ...
        <p className='explainerText'>
          ...
          UX-designer, as a part of the 2 year frontend developemnt education at
          KYH in Stockholm. We had UX-design courses in the frontend education
          and I really got hooked, and decided early on that I wanted to proceed
          a career within UX. My first task at Aline was to do a UX analysis of
          thier exisitng website.
