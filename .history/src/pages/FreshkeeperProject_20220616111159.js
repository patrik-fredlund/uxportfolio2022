      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperSprints'>
          <div className='uxProjectContainerSprints'>
            <h1>Sprints </h1>
            <h2>Sprint 1 - Discover - Week 1</h2>
            <h3>Set up the environment</h3>
            <p>Trello - scrum board.</p>
            <p>Figma - UI and wireframe</p>
            <h3>Explore ideas Workshop</h3>
            <p>research existing ideas</p>
            <p>Define choosen idea</p>
            <p>Research features for the App</p>
            <p>find the USP</p>
            <h3>Research user and competiotion</h3>
            <p>target group analysis</p>
            <p>competitor analysis</p>

            <h2>Sprint 2 - Define - Week 2</h2>

            <h3>Define the information and insights</h3>
            <p>target group </p>
            <p>competition </p>
            <p>Features </p>
            <p>Prioritize the features for an MVP prototype </p>

            <h2>Sprint 3 - Design - Week 3</h2>
            ...
            <p>Name workshop </p>
            <p>Create logo </p>
            <p>Choose fonts and colors </p>

            <h2>Sprint 4 - Design - Week 4</h2>

            <h3>Create Prototype</h3>

            <p>Create clickable prototype </p>
          </div>
        </div>
        ...
        <p className='MiddleIngressParagraph'>
          ...
          bring value to the user. With that in mind the next step of the
          discovery was to do a competitor analysis.
        </p>
        <hr></hr>
