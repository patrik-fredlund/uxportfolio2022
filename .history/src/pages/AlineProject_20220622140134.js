      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            website. This is still an ongoing process but during my time I'we I
            focused on the proirotized issues, such as navigation, first
            impression and delivery of the message, to make the website more
            product-centric. Since the orignal site was built in Squearespace I
            redesigned that.
          </p>
        </div>
        {/*  <h1>Recomended solutions </h1>
